...
| 탭 | 내용 |
|---|---|
| 지금 | 이동 시뮬레이션·ETA·진행률, 실 GPS 토글, 이동 중 장소 안내, 도착 알림(배너+진동) |
...
식사 밴드는 가격대·리뷰수·평점으로 정렬된 추천 목록에서 고릅니다.

## 알려진 제약

- **식당 추천·이동시간은 목업 데이터**입니다(`src/mock.ts`). 네이버/지도 API 키 확보 시 이 파일만 교체하면 됩니다.
